  ...
  return (
    <>
      <section className="bg-[#171719] relative pt-[9.125rem] pb-[0.625rem]">
        <h1 className="text-white text-[4rem] ml-[7.188rem] leading-[4.5rem] tracking-wide">
          Listen to music <br /> everywhere & anywhere
        </h1>
        <section className="flex">
          <article className="-mr-[4.375rem]">
            <p className="text-white text-[16px] ml-[7.188rem] w-full mt-[1.25rem] mb-[3.125rem]">
              Want to listen to music on the go? hafrikPlay is the best option
              for you to <br />
              listen to African Talents for free.
            </p>
            <div className="flex w-[41.688rem] mt-[4.375rem]">
            ...
            <div className="ml-[7.313rem] mt-[12.125rem] bg-[#14F195] px-[1.5rem] py-[2rem] rounded-[0.125rem] w-[34.375rem] h-[10.875rem] flex flex-col justify-center gap-[0.5rem]">
            ...
            <div className="ml-[7.313rem] mt-[3.375rem] bg-[#14F195] px-[1.5rem] py-[2rem] rounded-[0.125rem] w-[34.375rem] h-[10.875rem] flex flex-col justify-center gap-[0.5rem]">
      ...
      <section className="bg-[#36363A] pl-[7rem] pt-[9.25rem] pb-[13.563rem]">
        <p
          className="text-[3.5rem] text-[#FCFCFC] w-[70%] h-[13.5rem] leading-[4.5rem]"
          style={{
